...
const isOffline = () => !this.navigator.onLine
...
const storeRequest = async ({
  ...
  try {
    ...
    if ("sync" in this.registration) {
      ...
      await this.registration.sync.register(`retry-request`)
    }
  } catch (error) {
...
this.addEventListener("install", installHandler)
this.addEventListener("activate", activateHandler)
this.addEventListener("fetch", fetchHandler)
this.addEventListener("message", messageHandler)
this.addEventListener("sync", syncHandler)
